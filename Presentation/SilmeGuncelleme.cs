...
namespace Presentation
{
    public partial class SilmeGuncelleme : Form
    {
        ...
        private void dataGridView1_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            if (menuno == 0)
            {
                if (!Business.DesignPattern.TCPattern(dataGridView1.SelectedRows[0].Cells[0].Value.ToString()))
                {
                    MessageBox.Show("TC No Kurallara Uygun Değil", "Uyarı", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
                if (!Business.DesignPattern.CinsPattern(dataGridView1.SelectedRows[0].Cells[3].Value.ToString()))
                {
                    MessageBox.Show("Cinsiyet Yanlış Girildi", "Uyarı", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
                if (!Business.DesignPattern.TelPattern(dataGridView1.SelectedRows[0].Cells[5].Value.ToString()))
                {
                    MessageBox.Show("Telefon No Kurallara Uygun Değil", "Uyarı", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
            ...
            else if (menuno == 1)
            {
                ...
                if (!Business.DesignPattern.TelPattern(dataGridView1.SelectedRows[0].Cells[6].Value.ToString()))
                {
                    MessageBox.Show("Telefon No Kurallara Uygun Değil", "Uyarı", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
                if (!Business.DesignPattern.MailPattern(dataGridView1.SelectedRows[0].Cells[5].Value.ToString()))
                {
                    MessageBox.Show("Mail Kurallara Uygun Değil", "Uyarı", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
                string kimlikno = dataGridView1.SelectedRows[0].Cells[0].Value.ToString();
                string ad = dataGridView1.SelectedRows[0].Cells[1].Value.ToString();
        ...
        private void dataGridView1_EditingControlShowing(object sender, DataGridViewEditingControlShowingEventArgs e)
        {
            ...
            if ((menuno == 0 && (dataGridView1.CurrentCell.ColumnIndex == 0 || dataGridView1.CurrentCell.ColumnIndex == 5)) || (menuno == 1 && (dataGridView1.CurrentCell.ColumnIndex == 0 || dataGridView1.CurrentCell.ColumnIndex == 6)) || (menuno == 2 && dataGridView1.CurrentCell.ColumnIndex == 0))
                e.Control.KeyPress += dataGridViewTextBox_KeyPress;
        }

        private void dataGridViewTextBox_KeyPress(object sender, KeyPressEventArgs e)
        {
            _ = Business.DesignPattern.NumberHandler(sender, e);
        }
    }
}
