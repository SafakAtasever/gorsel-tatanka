...
namespace Presentation
{
    public partial class Sekreter1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                if (!Business.DesignPattern.TCPattern(textBox3.Text))
                {
                    MessageBox.Show("TC No Kurallara Uygun Değil");
                    return;
                }
                if (!Business.DesignPattern.TelPattern(textBox4.Text))
                {
                    MessageBox.Show("Telefon No Kurallara Uygun Değil");
                    return;
                }
            ...
            {
                if (!Business.DesignPattern.TCPattern(textBox13.Text))
                {
                    MessageBox.Show("TC No Kurallara Uygun Değil");
                    return;
                }
                if (!Business.DesignPattern.TelPattern(textBox15.Text))
                {
                    MessageBox.Show("Telefon No Kurallara Uygun Değil");
                    return;
                }
                if (!Business.DesignPattern.MailPattern(textBox14.Text))
                {
                    MessageBox.Show("Mail Adresi Geçerli Değil");
                    return;
                }
            ...
            {
                if (!Business.DesignPattern.TCPattern(textBox8.Text))
                {
                    MessageBox.Show("TC No Kurallara Uygun Değil");
                    return;
                }
        ...
        {
            bool cevap = Business.DesignPattern.NumberHandler(sender, e);
        }

        private void Sekreter1_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
    }
